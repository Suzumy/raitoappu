...
pythonコードをdisしたコードが配布されるため、これを復元していく
```
4           0 BUILD_LIST               0
              2 STORE_FAST               0 (a)
...
復元したコードが以下
```
a = [1739411, 1762811, 1794011, 1039911, 1061211, 1718321, 1773911, 1006611, 1516111, 1739411, 1582801, 
1506121, 1783901, 1783901, 1773911, 1582801, 1006611, 1561711, 1039911, 1582801, 1773911, 1561711, 1582801, 
1773911, 1006611, 1516111, 1516111, 1739411, 1728311, 1539421]
...
これを実行するとフラグを得ることができるため、それをsubmitする。